...
class PlaceList(Resource):
    ...
    def get(self):
        ...
        return [{'id': place.id, 'latitude': place.latitude, 'longitude': place.longitude, 'owner_id': place.owner_id, 'amenities': place.amenities} for place in places], 200
...
class PlaceResource(Resource):
    ...
    def put(self, place_id):
        ...
        if not validate_place_data(data):
            return {'error': 'Invalid input data'}, 400
        if place.owner_id != data.get('owner_id'):  # Vérifie si l'owner_id correspond
            return {'error': 'Forbidden: Only the owner can modify this place'}, 403
